...
const StickyDarkModeToggle = () => {
  ...
  hover:border-[#315543]/30 dark:hover:border-[#6A957A]/30
  transition-all duration-300 ease-out
  focus:outline-none focus:ring-4 focus:ring-[#315543]/30 dark:focus:ring-[#6A957A]/30
...
`}
        ...
        >
          ...
          <motion.div
            ...
            className="absolute inset-0 bg-linear-to-br from-[#315543]/20 to-[#6A957A]/20 rounded-full"
          />
          ...
          <AnimatePresence>
            <motion.div
              ...
              className="absolute inset-0 rounded-full bg-linear-to-r from-[#315543] to-[#6A957A]"
            />
          </AnimatePresence>
        </motion.button>
